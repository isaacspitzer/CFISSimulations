...
def AddGalaxyToCatalog(mag, hlr, sersicIndex, e1, e2, galCount, numRotations, catalogFiles, catWidth, catHeight):
	...
	catalogFiles.write('%i %f %f %f %f %f %f %f \n' % (galCount + currentGalaxyRotation, posX, posY, mag, hlr, sersicIndex, e1, e2))
...
for i in range(len(modelMagLists)):
	...
	leftovers = 0#numGalaxies % int(variables['num_rotations'])
